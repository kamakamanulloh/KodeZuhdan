 ...
 */
public class sesi2 extends Fragment {
    public static final String judul="Masa penjajahan oleh Belanda (1596-1942 M)";
...
//        View view=getActivity().getLayoutInflater().inflate(R.layout.activity_video,null);
//        dialog.setContentView(view);
//        VideoView videoView=(VideoView)view.findViewById(R.id.videoView2);
//        Button btnskip=(Button)view.findViewById(R.id.button);
////        VideoView.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.pidato));
